...
print("🚀 Running database migrations...".encode("utf-8"))
print("=" * 50)
...
if error_count == 0:
    print("\n✅ All migrations completed successfully!".encode("utf-8"))
    print("\n📝 Next steps:".encode("utf-8"))
    print("1. Load seed data: uv run seed_data.py".encode("utf-8"))
